...
= 5.1.28 =
- Fix Elementor form security token being cached and shared across visitors on pages served from cache

= 5.1.27 =
- Minor fixes

= 5.1.26 =
- Show transacional erros on WP panel
...
= 5.1.21 =
- Retrofit plugin with old versions

= 5.1.20 =
- Fixed bug related to cellphone field on contact forms.

= 5.1.19 =
- Change to use WP default checkbox system.
...
= 5.1.12 =
- Allow mapping of newsletter field

= 5.1.11 =
- Fix attach tag

= 5.1.10 =
- Fix getting tag to apply

= 5.1.09 =
- Add system journeys (abandoned cart)

= 5.1.08 =
- Add support to in_stock variable to API V3

= 5.1.07 =
- Add filter to get all extra fields without list fields
- Migrate Dasboard to API V3

= 5.1.06 =
- Fixed an issue causing incorrect behavior in certain checkout scenarios.
...
- Minor fixes on simple forms
- Improvement on RSS Feed

= 4.1.10 =
- Improve widget functionality
...
= 4.1.7 =
- Improved Elementor forms error handling
...
= 4.1.4 =
- Fix CF7 forms attach tag on add contact
- Fix egoi missing country codes select on simple forms
...
- Allow two or more e-goi simple forms in a single page
...
= 3.7.6 =
- Fixed transacional email error notice

= 3.7.5 =
- Fixed transactional email

= 3.7.4 =
- Email template minor fixes

= 3.7.3 =
- Campaign widget translations fixed
...
= 3.6.7 =
- Add: Already subscribed and waiting for confirmation e-mail message on Capture Contacts Subscriber bar
- Add: Default country to E-goi Simple Forms
...
= 3.6.4 =
- Add support to multiple HTTP libraries
...
= 3.4.1 =
- Added the product GTIN and Brand fields on WooCommerce Products inventory

= 3.4.0 =
- Elementor Form Integration

= 3.3.2 =
- Added KnowledgeBase links

= 3.3.1 =
- Minor tag bug fixes

= 3.3.0 =
- Social Product Tracking
...
- Subscription Bar improvements
- Minor bug fixes (Admin Page)
...
= 2.5.0 =
- Create your E-goi account without leaving the plugin
